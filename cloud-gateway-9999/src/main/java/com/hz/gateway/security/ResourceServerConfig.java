...
public class ResourceServerConfig {
    ...
    public Converter<Jwt, ? extends Mono<? extends AbstractAuthenticationToken>> jwtAuthenticationConverter() {
        ...
        jwtGrantedAuthoritiesConverter.setAuthorityPrefix(GatewayCoreConstant.AUTHORITY_PREFIX);
        jwtGrantedAuthoritiesConverter.setAuthoritiesClaimName(GatewayCoreConstant.AUTHORITY_CLAIM_NAME);
